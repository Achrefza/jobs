  ...
  return (
    <main className="px-6 py-16 lg:px-8">
      <ScrollReveal as="article" className="mx-auto max-w-4xl rounded-[2rem] border border-blue-100 bg-white p-8 card-shadow lg:p-12">
        ...
        <ScrollReveal as="section" className="mt-10 grid gap-5 sm:grid-cols-2" aria-label="Contact options">
          <div className="rounded-3xl bg-blue-50 p-6">
            ...
            <MotionAnchor className="focus-ring mt-4 inline-flex rounded-full bg-white px-4 py-2 text-sm font-black text-[#0a66c2]" href="mailto:hello@internshipsplus.com">
