    ...
    <main className="px-6 py-16 lg:px-8">
      <ScrollReveal as="article" className="mx-auto max-w-4xl rounded-[2rem] border border-blue-100 bg-white p-8 card-shadow lg:p-12">
        ...
        <div className="mt-8 space-y-8 leading-8 text-slate-600">
          <ScrollReveal as="section" aria-labelledby="terms-use">
          ...
          <ScrollReveal as="section" aria-labelledby="terms-external">
          ...
          <ScrollReveal as="section" aria-labelledby="terms-user">
          ...
          <ScrollReveal as="section" aria-labelledby="terms-changes">
          ...
          <ScrollReveal as="section" aria-labelledby="terms-contact">
