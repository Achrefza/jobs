...
export default function Home() {
  ...
  return (
    <main>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="animate-fade-up">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link className="focus-ring inline-flex items-center justify-center rounded-full border border-blue-100 bg-white px-7 py-4 text-base font-black text-[#0a66c2] transition hover:border-blue-300 hover:bg-blue-50" href="/about">
                Why trust us
              </Link>
            </div>
      ...
      <section className="px-6 py-16 lg:px-8" aria-labelledby="how-it-works-title">
        <div className="mx-auto max-w-7xl rounded-[2rem] border border-blue-100 bg-white p-8 card-shadow lg:p-10">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {howItWorks.map((item, index) => (
              <article className="rounded-3xl bg-blue-50 p-6" key={item}>
      ...
      <section className="px-6 py-16 lg:px-8" id="countries" aria-labelledby="countries-title">
