    ...
    <main className="px-6 py-16 lg:px-8">
      <ScrollReveal as="article" className="mx-auto max-w-4xl rounded-[2rem] border border-blue-100 bg-white p-8 card-shadow lg:p-12">
        ...
        <div className="mt-8 space-y-8 leading-8 text-slate-600">
          <ScrollReveal as="section" aria-labelledby="privacy-overview">
          ...
          <ScrollReveal as="section" aria-labelledby="privacy-data">
          ...
          <ScrollReveal as="section" aria-labelledby="privacy-external">
          ...
          <ScrollReveal as="section" aria-labelledby="privacy-ads">
          ...
          <ScrollReveal as="section" aria-labelledby="privacy-contact">
