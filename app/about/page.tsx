...
export default function AboutPage() {
  return (
    <main className="px-6 py-16 lg:px-8">
      <ScrollReveal as="article" className="mx-auto max-w-4xl rounded-[2rem] border border-blue-100 bg-white p-8 card-shadow lg:p-12">
        ...
        <ScrollReveal as="section" className="mt-10" aria-labelledby="mission-heading">
        ...
        <ScrollReveal as="section" className="mt-10" aria-labelledby="trust-heading">
        ...
        <MotionLink className="focus-ring mt-10 inline-flex rounded-full bg-[#0a66c2] px-6 py-3 text-sm font-black text-white" href="/#countries" lift="md">
